...
$html .= '<p style="font-size:20px;"><b>' .
    '<a href="http://mailspeise.at/MLW/" target="_blank">Download</a></b></p>';
$html .= '<p><b>Requires ' .
    '<a href="http://www.oracle.com/technetwork/java/javase/downloads/index.html" target="_blank">JRE 7</a>' .
    ' to run.</b></p>';
$html .= '<p>The program downloads a random wallpaper in given interval and changes the desktop background to ' .
    'downloaded wallpaper. The randoms <a href="' .
    PUB_PATH_CAT .
    'api/v1/random.json?limit=1&amp;search=major-colour%3Affffff" target="_blank">API</a>' .
    ' is used for wallpaper download.</p>';
$html .= '<p>This is a 3rd party program. For support or feedback, contact ' .
    '<a href="https://twitter.com/relgukxilef" target="_blank">@relgukxilef</a> at Twitter.</p>';
