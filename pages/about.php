...
$page_html .= '<p>As My Little Pony boom isn\'t going to last forever, I eventually decided to start adding new categories, such as <a href="' . PUB_PATH . 'c/cartoon-hangover/">Cartoon Hangover</a>, <a href="' . PUB_PATH . 'c/touhou/">Touhou</a> and <a href="' . PUB_PATH . 'c/vocaloid/">Vocaloid</a>.</p>';
$page_html .= '<h2>Using the search</h2>';
$page_html .= '<p><img src="' . PUB_PATH . 'search.png" style="float:right;margin:0 0 10px 10px;" alt="Search" title="Search autocomplete" />Since the search might be a bit difficult to use with no instructions, here\'s how you use it:</p>';
...
$page_html .= '<li>Android wallpapers (& themes): <i>platform:Android</i> [<a href="' . PUB_PATH_CAT . '?search=platform%3AAndroid" target="_blank">link</a>]</li>';
$page_html .= '<li>Twilight Sparkle wallpapers: <i>Twilight Sparkle</i> [<a href="' . PUB_PATH . '?c/my-little-pony/search=Twilight+Sparkle" target="_blank">link</a>]</li>';
$page_html .= '<li>Wallpapers in 16:9 aspect: <i>aspect:16:9</i> [<a href="' . PUB_PATH_CAT . '?search=aspect%3A16%3A9" target="_blank">link</a>]';
$page_html .= '<li>Desktop wallpapers by CountCarbon: <i>author:CountCarbon</i> & <i>platform:Desktop</i> [<a href="' . PUB_PATH . 'c/my-little-pony/?search=author%3ACountCarbon%2C+platform%3ADesktop" target="_blank">link</a>]';
$page_html .= '<li>Wallpapers with only Fluttershy: <i>=Fluttershy</i> [<a href="' . PUB_PATH . 'c/my-little-pony/?search=%3DFluttershy" target="_blank">link</a>]';
$page_html .= '<li>Wallpapers with only Fluttershy and Pinkie Pie: <i>=Fluttershy</i> & <i>=Pinkie Pie</i> [<a href="' . PUB_PATH . 'c/my-little-pony/?search=%3DFluttershy%2C+%3DPinkie+Pie" target="_blank">link</a>]';
$page_html .= '</ul>';
/*
