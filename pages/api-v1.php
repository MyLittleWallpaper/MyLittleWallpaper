...
$page_html .= '<ul>';
$page_html .= '<li>List: <a class="external" href="' . PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT . 'api/v1/list.json">' . PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT . 'api/v1/list.json</a></li>';
$page_html .= '<li>Random list: <a class="external" href="' . PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT . 'api/v1/random.json">' . PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT . 'api/v1/random.json</a></li>';
$page_html .= '</ul>';
$page_html .= '<h2>Request parameters</h2>';
$page_html .= '<p>You can give certain parameters to the calls in the URL, for example <a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?search=Fluttershy">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?search=Fluttershy</a></p>';
...
$page_html .= '<td class="api-description"><p>Search input (tags).</p><p>This parameter takes the same input you put to the search field on the website. For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?search=author%3Aharwicks-art%2C+Rarity">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?search=author%3Aharwicks-art%2C+Rarity</a><br /><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=platform%3AMobile%2C+%3DPinkie+Pie">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=platform%3AMobile%2C+%3DPinkie+Pie</a></p></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>searchAny</h4><em>optional</em></td>';
$page_html .= '<td class="api-description"><p>Search input (tags), match any.</p><p>This parameter takes the same input you put to the search field on the website. For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?searchAny=aspect%3A16%3A10%2Caspect%3A16%3A9">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?searchAny=aspect%3A16%3A10%2Caspect%3A16%3A9</a></p></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>searchExclude</h4><em>optional</em></td>';
$page_html .= '<td class="api-description"><p>Search input (tags), exclude from search.</p><p>This parameter takes the same input you put to the search field on the website. For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?searchExclude=Princess+Twilight">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?search=author%3Aharwicks-art%2C+Rarity</a></p></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>size</h4><em>optional</em></td>';
$page_html .= '<td class="api-description"><p>Search input (size).</p><p>Used to search for size equal or greater than. Only for desktop wallpapers.</p><p><strong>Accepted values are the following:</strong></p><p>• <strong>1</strong> - equeal or greater than <em>1920x1200</em><br />• <strong>2</strong> - equeal or greater than <em>1920x1080</em><br />• <strong>3</strong> - equeal or greater than <em>1680x1050</em><br />• <strong>4</strong> - equeal or greater than <em>1366x768</em><br />• <strong>5</strong> - equeal or greater than <em>2560x1600</em><br />• <strong>6</strong> - equeal or greater than <em>2560x1440</em></p><p>For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?size=5">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?size=5</a><br /><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=author%3Aharwicks-art%2C+Rarity&#38;size=1">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=author%3Aharwicks-art%2C+Rarity&#38;size=1</a></p></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>date</h4><em>optional</em></td>';
$page_html .= '<td class="api-description"><p>Search input (date added).</p><p>Searches for wallpapers added on specific date (EET/EEST). Date format <em>YYYY-MM-DD</em>. For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?date=2013-01-24">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?date=2013-01-24</a><br /><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=%3DRarity&#38;date=2013-01-24">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=%3DRarity&#38;date=2013-01-24</a></p></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>limit</h4><em>optional</em></td>';
$page_html .= '<td class="api-description"><p>Limits the maximum number of results.</p><p><strong>Default:</strong></p><p>• <em>random.json</em> - 1<br />• <em>list.json</em> - 10</p><p><strong>Max value:</strong></p><p>• <em>random.json</em> - 20<br />• <em>list.json</em> - 100</p><p>For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?date=2013-01-24&#38;limit=5">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/random.json?date=2013-01-24&#38;limit=5</a><br /><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=%3DPrincess+Luna&#38;limit=20">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?search=%3DPrincess+Luna&#38;limit=20</a></p></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>sort</h4><em>optional</em><p>Not applicable with random.json</p></td>';
$page_html .= '<td class="api-description"><p>Result sorting.</p><p>Accepts only one value, which is <em>popularity</em>. If left empty, results are sorted by date added, newest first. For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?date=2013-01-24&#38;sort=popularity">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?date=2013-01-24&#38;sort=popularity</a></p></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>offset</h4><em>optional</em><p>Not applicable with random.json</p></td>';
$page_html .= '<td class="api-description"><p>Result offset.</p><p>Define offset where the result listing starts from. For example:</p><p><a class="external" href="' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?date=2013-01-24&#38;offset=10">' . PROTOCOL . SITE_DOMAIN . '/c/all/api/v1/list.json?date=2013-01-24&#38;offset=10</a></p></td>';
$page_html .= '</tr>';
$page_html .= '</table>';
