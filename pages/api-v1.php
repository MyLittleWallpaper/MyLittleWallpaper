...
$page_html .= '<ul>';
$page_html .= '<li>List: <a class="external" href="' . PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT . 'api/v1/list.json">' .
    PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT . 'api/v1/list.json</a></li>';
$page_html .= '<li>Random list: <a class="external" href="' . PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT .
    'api/v1/random.json">' . PROTOCOL . SITE_DOMAIN . PUB_PATH_CAT . 'api/v1/random.json</a></li>';
$page_html .= '</ul>';
$page_html .= '<h2>Request parameters</h2>';
$page_html .= '<p>You can give certain parameters to the calls in the URL, for example <a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Search input (tags).</p><p>This parameter takes the same input you put to the search field on the website. For example:</p><p><a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Search input (tags), match any.</p><p>This parameter takes the same input you put to the search field on the website. For example:</p><p><a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Search input (tags), exclude from search.</p><p>This parameter takes the same input you put to the search field on the website. For example:</p><p><a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Search input (date added).</p><p>Searches for wallpapers added on specific date (EET/EEST). Date format <em>YYYY-MM-DD</em>. For example:</p><p><a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Limits the maximum number of results.</p><p><strong>Default:</strong></p><p>• <em>random.json</em> - 1<br />• <em>list.json</em> - 10</p><p><strong>Max value:</strong></p><p>• <em>random.json</em> - 20<br />• <em>list.json</em> - 100</p><p>For example:</p><p><a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Result sorting.</p><p>Accepts only one value, which is <em>popularity</em>. If left empty, results are sorted by date added, newest first. For example:</p><p><a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Result offset.</p><p>Define offset where the result listing starts from. For example:</p><p><a class="external" href="' .
...
$page_html .= '<td class="api-description"><p>Tags used in search as an array.</p><p>For example:</p><div class="source-code">' .
...
$page_html .= '<td class="api-description"><p>Amount of wallpapers in result.</p><p>For example:</p><div class="source-code">' .
...
$page_html .= '<td class="api-description"><p>Offset of the listing.</p><p>For example:</p><div class="source-code">' .
...
$page_html .= '<td class="api-description"><p>Amount of total results of the search.</p><p>For example:</p><div class="source-code">' .
...
$page_html .= '<td class="api-description"><p>Wallpaper title.</p><p>For example:</p><div class="source-code">' .
...
$page_html .= '<td class="api-description"><p>Wallpaper image identifier.</p><p>This identifier can be used to get thumbnails from the site: <code>' .
...
$page_html .= '<td class="api-description"><p>Wallpaper download URL.</p><p>For example:</p><div class="source-code">' .
    $hyperLight->render(
...
$page_html .= '<td class="api-description"><p>Wallpaper dimensions. Not present if not applicable, like with Android live wallpapers and themes.</p><p>For example:</p><div class="source-code">' .
...
$page_html .= '<td class="api-description"><p>Wallpaper authors as an array.</p><p>For example:</p><div class="source-code">' .
    $hyperLight->render('"authors":["CaNoN-lb","impala99"]') . '</div></td>';
$page_html .= '</tr>';
$page_html .= '<tr>';
$page_html .= '<td class="api-field"><h4>clicks</h4><em>always present</em></td>';
$page_html .= '<td class="api-description"><p>Amount of wallpaper download link clicks.</p><p>For example:</p><div class="source-code">' .
