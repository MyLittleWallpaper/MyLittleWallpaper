...
$page_html .= '<ul>';
$page_html .= '<li>List: <a class="external" href="http://www.mylittlewallpaper.com' . PUB_PATH_CAT . 'api/v1/list.json">http://www.mylittlewallpaper.com' . PUB_PATH_CAT . 'api/v1/list.json</a></li>';
$page_html .= '<li>Random list: <a class="external" href="http://www.mylittlewallpaper.com' . PUB_PATH_CAT . 'api/v1/random.json">http://www.mylittlewallpaper.com' . PUB_PATH_CAT . 'api/v1/random.json</a></li>';
$page_html .= '</ul>';
