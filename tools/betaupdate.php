...
if (PHP_SAPI == 'cli') {
	...
	while($wallpaper = $result->fetch(PDO::FETCH_ASSOC)) {
		...
		$db->query("INSERT INTO wallpaper_tag_aspect (tag_aspect_id, wallpaper_id) VALUES (?, ?)", [$ratio_id, $wallpaper['id']]);
		...
		$db->query("INSERT INTO wallpaper_tag_artist (tag_artist_id, wallpaper_id) VALUES (?, ?)", [$artist_id, $wallpaper['id']]);
